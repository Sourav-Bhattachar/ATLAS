...
def play_rotating_lines(root, container):
    ...
    # threading.Thread(target=lambda: playsound(music_dir), daemon=True).start()
    playsound(music_dir)
    ...
    stop_video = False  # Flag to stop video loop safely
    ...
    def update_frame():
        ...
        if ret:
            ...
            # If video ends, loop back to the start
    ...
    def clear_canvas():
        ...
        # FaceAuthSuccessful.play_success(root, container)
